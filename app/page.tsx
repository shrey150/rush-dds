    ...
    <div className="relative min-h-screen bg-black text-white overflow-hidden font-serif">
      ...
      <div className="relative z-10 container mx-auto px-4 flex flex-col items-center justify-center min-h-screen py-20">
        <div className="max-w-3xl w-full mx-auto text-center flex flex-col gap-8 items-center">
          {/* Desktop heading */}
          <div className="w-full hidden md:flex font-serif justify-center">
            <h1 className="text-8xl tracking-tight text-transparent bg-clip-text bg-gradient-to-b from-gold-400 to-gold-600 font-serif font-normal">
              DDS
            </h1>
          </div>
          ...
          <div className="w-full md:hidden">
            <h1 className="text-6xl tracking-tight text-transparent bg-clip-text bg-gradient-to-b from-gold-400 to-gold-600 font-serif font-normal">
              DDS
            </h1>
          </div>
